...
(async function () {
  ...
  const 引流 = [
    "https://hamigua.cutespirit.org/index.php/2021/10/25/about-me/"
  ]
...
`
  ...
  const initConfig = {
    ...
    content: {
      ...
      skin: ["想看我的好朋友嗎?", "替换后入场文本"], // 0更换模型提示文案  1更换完毕入场文案
      custom: [
        // 鼠标移上去提示元素
  ...
  function 加载圣·嘉然() {
    ...
    topBtn.onmouseover = function () {
      pio_reference.modules.render("想回到網頁頂部嗎？");
    };
  ...
  function onModelLoad(model) {
    ...
    if (modelNmae === "Diana") {
      ...
      // 入场动作及文案
      initConfig.content.skin[1] = ["我是可愛擔當 哈密瓜 hamigua~", "可愛的高中生們 想我了没有呀~", "有人在嗎？"]
      ...
      touchList = [
        ...
        {
          text: "你怎麼老摸我，我的身體是不是可有魅力",
          motion: "Tap嘴"
        },
        {
          text: "AAAAAAAAAAvvvvAAA 哈密瓜好可愛啊！",
          motion: "Tap左眼",
          from: {
            "Part15": 1
          },
